...
CATEGORY_RULES = {
    ...
    'api': "['*']",
    'ai': "['data.*', 'string.*', 'file.*', 'http.*', 'flow.*', 'start']",
    'cloud': "['data.*', 'file.*', 'http.*', 'flow.*', 'start']",
    'developer': "['*']",
    'payment': "['data.*', 'http.*', 'flow.*', 'start']",
    'productivity': "['data.*', 'http.*', 'flow.*', 'start']",

    # Integration categories
    'jira': "['data.*', 'http.*', 'flow.*', 'start']",
    'salesforce': "['data.*', 'http.*', 'flow.*', 'start']",
