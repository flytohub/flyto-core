...
- [Tool Catalog](TOOL_CATALOG.md): all 466 active runtime modules, parameters,
  and outputs.
...
- 948 maintained Python files and 5,489 declarations.
- 481 literal module registrations linked to source.
