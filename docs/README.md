...
- [Tool Catalog](TOOL_CATALOG.md): all 464 active runtime modules, parameters,
  and outputs.
...
- 946 maintained Python files and 5,460 declarations.
- 479 literal module registrations linked to source.
