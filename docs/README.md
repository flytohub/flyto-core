...
- [Tool Catalog](TOOL_CATALOG.md): all 461 active runtime modules, parameters,
  and outputs.
...
- 943 maintained Python files and 5,433 declarations.
- 476 literal module registrations linked to source.
