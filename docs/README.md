...
- [Tool Catalog](TOOL_CATALOG.md): all 465 active runtime modules, parameters,
  and outputs.
...
- 947 maintained Python files and 5,470 declarations.
- 480 literal module registrations linked to source.
