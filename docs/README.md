...
- [Tool Catalog](TOOL_CATALOG.md): all 467 active runtime modules, parameters,
  and outputs.
...
- 949 maintained Python files and 5,498 declarations.
- 482 literal module registrations linked to source.
