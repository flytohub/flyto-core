...
- 461 modules are active in the checked catalog generation environment.
- 85 categories group that active catalog.
- 476 literal decorator registrations exist in maintained source.
...
- [All 461 active module schemas](TOOL_CATALOG.md)
- [All 476 literal module implementations](reference/registered-modules.md)
- [All 5,433 maintained Python declarations](reference/python-api.md)
