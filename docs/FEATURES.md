...
- 474 modules are active in the checked catalog generation environment.
- 85 categories group that active catalog.
- 489 literal decorator registrations exist in maintained source.
...
- [All 474 active module schemas](TOOL_CATALOG.md)
- [All 489 literal module implementations](reference/registered-modules.md)
- [All 5,527 maintained Python declarations](reference/python-api.md)
