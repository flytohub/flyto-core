...
|---|---:|
| Runtime catalog | 461 modules, 85 categories |
| Literal module registrations | 476 |
| Packaged recipes | 41 |
| Maintained Python source | 943 files, 190,753 lines |
| Python declarations | 5,433 across 796 files |
