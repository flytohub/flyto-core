...
|---|---:|
| Runtime catalog | 467 modules, 85 categories |
| Literal module registrations | 482 |
| Packaged recipes | 41 |
| Maintained Python source | 949 files, 190,753 lines |
| Python declarations | 5,498 across 803 files |
