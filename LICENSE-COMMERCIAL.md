...
1. [When You Need a Commercial License](#1-when-you-need-a-commercial-license)
2. [License Tiers](#2-license-tiers)
3. [Pricing Structure](#3-pricing-structure)
4. [License Terms](#4-license-terms)
5. [Frequently Asked Questions](#5-frequently-asked-questions)
6. [How to Purchase](#6-how-to-purchase)
7. [Enterprise Agreements](#7-enterprise-agreements)

---

## 1. When You Need a Commercial License

You **MUST** obtain a commercial license if you intend to:

### 1.1 Direct Commercial Activities
...
|----------|-----------------|
| Personal projects and learning | No |
...
- Custom feature development (additional fee)
...
| Tier | Annual Fee (USD) | Per-Developer Fee |
|------|-----------------|-------------------|
| Startup | $499/year | Included (up to 5) |
| Business | $2,499/year | $99/developer/year |
...
### 3.3 Non-Profit Discount

Registered non-profit organizations may qualify for a 50% discount on all tiers.

### 3.4 Educational Discount

Accredited educational institutions may qualify for a 75% discount on all tiers.
...
- **Update Access**: Receive updates for the license period
...
- All licenses are annual subscriptions
- Licenses auto-renew unless cancelled 30 days before renewal
- Upon expiration, you may continue using the version you have, but:
  - No new updates
  - No support
  - Must stop commercial activities with new deployments
...
- Licensee covers costs if violation found
- Licensor covers costs if compliant
...
### Q4: Do I need a license for each environment?

**A:** No. A single license covers development, staging, and production environments within your organization.
...
**A:** Support varies by tier:
- **Startup**: Email support, 48-hour response
- **Business**: Priority email, 24-hour response
- **Enterprise**: Dedicated channel, custom SLA

### Q8: How are updates delivered?

**A:** Updates are delivered through:
- GitHub releases (with license key access)
- Private package registry (Enterprise)
- Direct download portal

### Q9: What if I need custom features?

**A:** Enterprise customers can request custom feature development for an additional fee. Contact sales for a quote.

### Q10: How do I prove I have a license?

**A:** Upon purchase, you receive:
- License certificate (PDF)
- License key (for validation)
- License agreement (signed copy)

---

## 6. How to Purchase

### 6.1 Online Purchase (Startup & Business)

1. Visit: https://flyto.dev/pricing
2. Select your tier
3. Complete the checkout process
4. Receive license key immediately

### 6.2 Enterprise & OEM

1. Contact: enterprise@flyto.dev
...
| Purpose | Contact |
|---------|---------|
| Sales Inquiries | sales@flyto.dev |
| Enterprise Sales | enterprise@flyto.dev |
| Licensing Questions | licensing@flyto.dev |
| Technical Pre-Sales | presales@flyto.dev |

### 6.4 Required Information

When contacting sales, please provide:
...
- **Volume licensing**: Discounted rates for large deployments
- **Multi-year agreements**: Lock in pricing with extended terms
- **Custom SLAs**: Guaranteed response times and uptime
- **Source code escrow**: Protection in case of business continuity issues
- **Indemnification**: Protection against IP claims
- **Audit procedures**: Custom audit terms
- **Liability caps**: Negotiable liability limits

### 7.2 Enterprise Support Options

| Option | Description |
|--------|-------------|
| Standard | Email support, 8-hour response |
| Premium | Slack channel, 4-hour response |
| Critical | Phone support, 1-hour response |
| Dedicated | Assigned support engineer |
...
| Service | Description |
|---------|-------------|
| Implementation | Guided deployment and setup |
| Training | Developer and administrator training |
| Custom Development | Feature development for your needs |
| Architecture Review | Best practices and optimization |
| Migration | Help moving from other platforms |

---

## 8. License Agreement Template

Below is a summary of the commercial license agreement terms. The full agreement is provided upon purchase.
...
5. WARRANTY
   - Software performs materially as documented
   - 90-day warranty period from delivery
   - Exclusive remedy: repair or replacement
...
7. CONFIDENTIALITY
   - License terms are confidential
   - Source code is confidential
   - Standard mutual NDA terms apply
...
### 9.1 License Key Validation

Commercial licenses include a license key that:

- Validates your license status
- Enables commercial features
- Provides update access
- Does NOT phone home or collect data

### 9.2 Reporting Requirements

Licensees must:

- Report accurate developer counts annually
- Notify of material changes in usage
...
- Requirement to pay back-dated fees at 150% rate
- Public disclosure of violation (in egregious cases)

---

## 10. Contact Us

We're here to help you find the right licensing solution.

**Sales Team**
- Email: sales@flyto.dev
...
**Website**
- Pricing: https://flyto.dev/pricing
- Documentation: https://flyto.dev/docs
- FAQ: https://flyto.dev/licensing/faq
