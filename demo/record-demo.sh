...
run_demo() {
    ...
    clear
    echo -e "${BOLD}flyto-core${RESET} — 452 modules, trace every step, replay from any point"
    echo
    pause 2
    ...
    echo -e "452 modules. Trace every step. Replay from any point."
...
case "${1:-record}" in
    ...
    *)
        ...
        asciinema rec \
            --title "flyto-core: 452 modules, trace everything, replay from any point" \
            --cols 90 \
            --rows 32 \
