...
> **The open-source execution engine for AI agents. 466 modules, MCP-native, triggers, queue, versioning, metering.**
>
...
The current public inventory is **466 registry-backed modules** across **85
...
- **466 registry-backed modules** across **85 catalog categories**. `docs/TOOL_CATALOG.md` is generated from `ModuleRegistry`, not hand-counted.
...
## 466 Modules, 85 Catalog Categories
...
Your AI gets all 466 modules as tools.
