...
> **The open-source execution engine for AI agents. 461 modules, MCP-native, triggers, queue, versioning, metering.**
>
...
The current public inventory is **461 registry-backed modules** across **85
...
- **461 registry-backed modules** across **85 catalog categories**. `docs/TOOL_CATALOG.md` is generated from `ModuleRegistry`, not hand-counted.
...
- **Short:** flyto-core is the open-source execution engine for AI agents: 461 modules, MCP-native, triggers, queue, versioning, metering.
- **Technical:** flyto-core exposes 461 registry-backed modules across 85 catalog categories through CLI, API, YAML recipes, and MCP server transports so agents and operators compose deterministic workflows with triggers, queues, workflow versioning, metering hooks, trace, evidence capture, and replay.
...
## 461 Modules, 85 Catalog Categories
...
Your AI gets all 461 modules as tools.
