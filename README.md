...
> **The open-source execution engine for AI agents. 467 modules, MCP-native, triggers, queue, versioning, metering.**
>
...
The current public inventory is **467 registry-backed modules** across **85
...
- **467 registry-backed modules** across **85 catalog categories**. `docs/TOOL_CATALOG.md` is generated from `ModuleRegistry`, not hand-counted.
...
## 467 Modules, 85 Catalog Categories
...
Your AI gets all 467 modules as tools.
