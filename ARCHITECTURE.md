...
- `docs/TOOL_CATALOG.md` is generated from the module registry; it is the
  source of truth for the current 474-module, 85-category public inventory.
...
- `docs/reference/` is generated from Python AST and repository assets. It maps
  952 maintained Python files, 5,527 declarations, 489 literal module
  registrations, 22 HTTP operations, 105 environment names, CLI parsers,
