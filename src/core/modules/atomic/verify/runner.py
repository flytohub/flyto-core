...
@register_module(
    ...
    params_schema=compose(
        schema_field('url', type='string', required=True, description='URL to verify'),
        schema_field('selectors', type='array', required=False, description='CSS selectors to verify'),
        schema_field('ruleset_path', type='string', required=False, description='Path to YAML ruleset file'),
        schema_field('expected_styles', type='object', required=False, description='Expected styles per selector'),
        schema_field('figma_file_id', type='string', required=False, description='Figma file ID for comparison'),
        schema_field('figma_token', type='string', required=False, description='Figma token (or FIGMA_TOKEN env)'),
        ...
        schema_field('report_format', type='string', required=False, default='html', description='Report format'),
