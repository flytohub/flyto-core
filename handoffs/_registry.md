...
| --- | --- | --- | --- |
| 2026-08-30 | Isolated runtime authority and browser-profile convergence | `2026-08-30-isolated-runtime-convergence.md` | Verified in an isolated no-push clone: opaque execution policy/profile/resolver objects, bounded template recursion, strict explicit popup semantics, visible-match hidden waits, and lock-safe per-principal profiles. Core non-browser/non-E2E suite 3,090 passed / 126 skipped / 0 failed at 64.05% coverage. Coordinated Cloud gates are recorded in the handoff. Not merged, pushed, deployed, or live-site verified. Owner: codex |
| 2026-08-30 | Browser click outcome verification | `2026-08-30-browser-click-outcome-verification.md` | Implemented locally on `main`, not pushed: `browser.click` 1.3.0 separates dispatch from verified effects, rejects unfulfilled popup intent and pre-existing terminal states, and leaves tab adoption unchanged. Focused unit/real Chromium contracts, generated docs/catalog, and closure gates recorded in the handoff. Owner: codex |
