...
| --- | --- | --- | --- |
| 2026-08-28 | Semantic browser.click closure | `2026-08-28-browser-click-semantic-closure.md` | Implemented on `main`: Element Picker and click share visible accessible names; icon-only links execute without CSS/XPath; configured timeout and navigation detection fixed. Real EVTEK login-to-portal proof passed. No attendance action executed. Owner: codex |
